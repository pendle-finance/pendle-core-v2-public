...
contract ActionMarketCoreStatic is StorageLayout, IPActionMarketCoreStatic {
    ...
    function _mintSyFromTokenStatic(
        ...
        return
            IPRouterStatic(address(this)).mintSyFromTokenStatic(_getSyMarket(market), tokenIn, netTokenToDeposit, bulk);
    }
    ...
    function _redeemSyToTokenStatic(
        ...
        return IPRouterStatic(address(this)).redeemSyToTokenStatic(_getSyMarket(market), tokenOut, netSyToRedeem, bulk);
    }
