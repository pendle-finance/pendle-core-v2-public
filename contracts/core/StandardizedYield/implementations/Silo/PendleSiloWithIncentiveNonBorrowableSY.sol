...
contract PendleSiloWithIncentiveNonBorrowableSY is SYBaseWithRewards {
    ...
    function _deposit(
        ...
        if (tokenIn == collateralToken) {
            ...
            (, amountSharesOut) = ISilo(silo).deposit(asset, amountDeposited, true);
        }
    }
    ...
    function _redeem(
        ...
        if (tokenOut == collateralToken) {
            ...
            // bear any fees
            ISilo(silo).withdraw(asset, amountTokenOut, true);
