...
import "./PendleSolvHelperBSC.sol";
import "../../../../interfaces/IPExchangeRateOracle.sol";

contract PendleSolvBTCBBNBSCSYUpg is SYBaseUpg {
    event SetNewExchangeRateOracle(address oracle);

    address public constant WBTC = PendleSolvHelperBSC.WBTC;
    address public constant SOLV_BTC = PendleSolvHelperBSC.SOLV_BTC_TOKEN;
    address public constant SOLV_BTCBBN = PendleSolvHelperBSC.SOLV_BTCBBN_TOKEN;
    ...
    function initialize(address _initialExchangeRateOracle) external initializer {
        ...
        _safeApproveInf(WBTC, PendleSolvHelperBSC.SOLV_BTC_ROUTER);
        _safeApproveInf(SOLV_BTC, PendleSolvHelperBSC.SOLV_BTCBBN_ROUTER);
    }
    ...
    function _deposit(address tokenIn, uint256 amountDeposited) internal virtual override returns (uint256) {
        ...
        return PendleSolvHelperBSC._mintBTCBBN(tokenIn, amountDeposited);
    }
    ...
    function _previewDeposit(
        ...
        return PendleSolvHelperBSC._previewMintBTCBBN(tokenIn, amountTokenToDeposit);
    }
